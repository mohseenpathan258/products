...
def main(page: ft.Page):
    ...
    def switch_page(page_name):
        ...
        if page_name == "home":
            ...
            page.controls.append(Invoice(page))
    ...
    # show invoices btn
    show_invoices = ft.PopupMenuItem(
        content=ft.Row(
            controls=[
                # show invoices icon
                ft.Icon(
                    name=ft.Icons.RECEIPT,
                    color="#008FD5"
                ),
        ...
        on_click=lambda e: switch_page("invoice")
    )
    # page appbar
        ...
        title=ft.Row(
            controls=[
                ft.Container(
                    ...
                    border_radius=20,
                    # content=ft.Image(
                    #     src="https://media-hosting.imagekit.io//628455647d6b4783/logo.png?Expires=1834034333&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=wUDxlOakVjAHfeE~G4UnwsdxVesiJ4WJat9d~eV4wWsvhc63~pmWSaWauWSgiiJXfyfdzWCfZAVypadfY-KTZjDqE4zsDCweGrWJGfNHyetRoMZ6BU-PJI-pZC1oRL4yM7TCpX8Ce0uj3DcvMOCNRFDIYUpW1r9txBzguFRasKdR7KXLEZQPh4WpbioupAbWtVKjqEQd-qxXYXQbuirIRNzCMEXxozg8vXq~RURirsN-JzFnLXdX1MMJOflMpQ3S1Qu3CDMSdsagBcK0fg2k-AZV9o-~y4MDOmpcBb~13CPv02a525YbLRRxGYkOaHbHVwmmpkUXj9pbWDfjKuo87w__"
                    # ),
                    ...
                    ft.PopupMenuItem(
                        content=ft.Column(
                            ...
                            controls=[
                                ...
                                # percent button instruction
                                ft.Text(
                                    value="On click percent button you can set sale percent",
                                    color=ft.Colors.GREY,
                                )
                            ]
                        )
